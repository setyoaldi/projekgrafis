...
public class Tatasurya implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public static void main(String[] args) {
        Frame frame = new Frame("Tata Surya");
        GLCanvas canvas = new GLCanvas();
        canvas.addGLEventListener(new Tatasurya());
        frame.add(canvas);
